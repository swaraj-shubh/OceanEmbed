...
(+331k parameters). Against raw Argo it scores **0.908** — identical to M2's **0.908**, to
three decimals. Early stopping did not change it, so it is not overfitting. Reported as a
null result.
