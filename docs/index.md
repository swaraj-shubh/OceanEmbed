...
| [**12 — Day 4 · Latest Results**](12-day4-audit.md) | **Current page.** Three directions closed: six alternative correction forms (all null), per-depth ensemble weights (null), and an error budget showing 62% of what remains sits in 75–150 m as *variance, not bias* — beyond the reach of post-hoc correction |
